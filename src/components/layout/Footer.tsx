        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/doctors" className="hover:text-secondary">
                  Our Doctors
                </Link>
              </li>
              <li>
          ...
          {/* Contact Details */}
          <div>
            <h3 className="mb-4 text-lg font-semibold text-secondary">Contact Details</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                <Clock size={18} className="mt-1 shrink-0 text-secondary" />
                <span>
                  8:00 - 17:00
                  <br />
                  Monday - Friday
          ...
          {/* Newsletter */}
          <div>
            <h3 className="mb-4 text-lg font-semibold text-secondary">Newsletter</h3>
